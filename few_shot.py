...
#         del self.model.fc
#
#         state_dict = torch.load(os.path.join(self.model_name))
...
FEW_SHOT_DATASETS = {
    ...
    'STL10': [datasets.STL10, '../data/STL10', 10, 'accuracy']
}
...
if __name__ == "__main__":
    ...
    parser.add_argument('-i', '--image-size', type=int, default=32, help='the size of the input images')
    parser.add_argument('--n-way', type=int, default=5,
                        help='the number of classes per episode (n-way) in few-shot evaluation')
    parser.add_argument('--n-support', type=int, default=5,
                        help='the number of images per class for fitting (n-support) in few-shot evaluation')
    parser.add_argument('--n-query', type=int, default=15,
                        help='the number of images per class for testing (n-query) in few-shot evaluation')
    parser.add_argument('--iter-num', type=int, default=100,
                        help='the number of testing episodes in few-shot evaluation')
    ...
    datamgr = few_shot_utils.SetDataManager(dset, data_dir, num_classes,
                                              args.image_size, n_episode=args.iter_num,
